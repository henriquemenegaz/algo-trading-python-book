...
class MRVectorBacktester(MomVectorBacktester):
    ...
    def run_strategy(self, SMA_LENGTH, threshold):
        """Backtests the trading strategy."""
        data = self.data.copy().dropna()
        data["sma"] = data["price"].rolling(SMA_LENGTH).mean()
